import { useState, useEffect } from "react"; // تمت إضافة useEffect
    ...
    <div className="space-y-8 animate-fade-in pb-12">
      <div className="bg-primary/5 p-8 rounded-3xl border border-primary/10">
        ...
        <p className="text-muted-foreground text-lg max-w-2xl">
          Browse through our extensive catalog of professional courses led by
          industry experts.
        </p>
      </div>
        ...
        <div className="flex gap-2 overflow-x-auto pb-2 md:pb-0">
          ...
          {categories.map((cat) => (
            <Button
              key={cat.categoryId}
              variant={
                selectedCategoryId === cat.categoryId ? "default" : "outline"
              }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {courses.map((course) => {
          ...
          return (
            <Card
              key={course.courseId}
              className="group overflow-hidden hover:shadow-2xl transition-all duration-500 border-none bg-white"
            >
              ...
              <CardContent className="p-5 pt-0">
                ...
                <div className="flex gap-2">
                  ...
                  course.instructorId === user.id ? (
                    ...
                    <Button
                      asChild
                      className="w-full rounded-xl font-bold shadow-glow hover:shadow-none bg-green-500 hover:bg-green-600"
                    >
                      <Link
                    ...
                    <Button
                      asChild
                      className="w-full rounded-xl font-bold bg-gradient-to-r from-emerald-500 to-green-600 text-white shadow-md hover:opacity-90 transition-opacity"
                    >
                      <Link
                    ...
                    <Button
                      asChild
                      className="w-full rounded-xl font-bold shadow-glow hover:shadow-none"
                    >
